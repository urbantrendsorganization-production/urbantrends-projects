...
Nothing at present. The three questions this section has carried — the refund terms, the `slotLost` remedy, and per-shop M-Pesa credentials — are all settled above, with the reasoning kept rather than deleted so they are not reopened by accident.
